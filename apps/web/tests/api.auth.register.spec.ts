...
describe('POST /api/auth/register', () => {
  ...
  // it('AUTH_REGISTER-TC-11: 異常：Content-Type ヘッダ無し（400）', async () => {
  //   const req = new Request('http://localhost/api/auth/register', {
  //     method: 'POST',
  //     // content-type を付けない（= get が null）
  ...
  // it('AUTH_REGISTER-TC-CT-01: 異常：Content-Type 不正（400） ※cover line7', async () => {
  //   const req = new Request('http://localhost/api/auth/register', {
  //     method: 'POST',
  //     headers: { 'content-type': 'text/plain' }, // ← ここが重要
  //     body: JSON.stringify({ userId: 'u', password: 'p' }),
  //   });
