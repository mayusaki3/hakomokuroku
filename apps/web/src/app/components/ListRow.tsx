...
import { Package as BoxIcon, PackageSearch as UnassignedIcon, Pencil as PencilIcon } from "lucide-react";
...
export default function ListRow(p: Props) {
  ...
  return (
    <div className="grid grid-cols-[48px_1fr_auto] items-center gap-3 px-3 py-2 border-b">
      ...
      {/* 編集 */}
      <Link href={p.hrefEdit} aria-label={`${p.name} を編集`} className="p-2 rounded hover:bg-muted">
