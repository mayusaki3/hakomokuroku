      ...
      <div className="app-scroll">
        <section className="hk-frame">
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <button className="btn" style={{ marginLeft: 'auto' }} onClick={() => router.back()}>
              戻る
            </button>
          </div>
          <hr
            style={{ border: 0, borderTop: '1px solid var(--hk-border,#e5e7eb)', margin: '6px 0' }}
          />
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginTop: 12 }}>
                ...
                <input
                  ...
                  style={{ width: 120 }}
                />
                <button className="btn" onClick={onVerify} disabled={!secret || code.length !== 6}>
                  確認・セットアップ
                </button>
              </div>
              ...
              {Array.isArray(doneCodes) && (
                <div style={{ marginTop: 12 }}>
                  ...
                  <div style={{ marginTop: 8, display: 'flex', gap: 8 }}>
                    ...
                    <button className="btn" onClick={() => location.replace('/account/mfa')}>
                      完了
                    </button>
                  </div>
                </div>
