...
export default function LabelsA4Page() {
  ...
  return (
    <main style={{ padding: 0 }}>
      ...
      >
        <strong>/print/labels</strong> — A4面付け印刷（{o}, {cols}列, gap {gap}mm, n={n}, QR{' '}
        {qrSizeMm}mm, margin {qrMargin})
        <div style={{ marginTop: 8, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          >
            向きを{o === 'portrait' ? '横' : '縦'}にする
          </a>
        </div>
        <p style={{ marginTop: 8, color: '#555' }}>
          ※ ブラウザ印刷で「余白なし／スケール100%」は必ずオフにし、<b>スケール=100%</b>
          にしてください（ここで余白10mmを確保しています）。
        </p>
      </div>
